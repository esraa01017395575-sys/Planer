-- 1. Update/Recreate Quotes Table for Localization
...
-- 4. Insert 60 Localized Quotes (Egyptian Arabic - العامية)
...
('Energy and persistence conquer all things.', 'الطاقة والإصرار بيغلبوا أي حاجة.', 'Benjamin Franklin', 'persistence'),
